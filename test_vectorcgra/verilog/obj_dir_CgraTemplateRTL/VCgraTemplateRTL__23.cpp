...
VL_INLINE_OPT void VCgraTemplateRTL::_combo__TOP__547(VCgraTemplateRTL__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCgraTemplateRTL::_combo__TOP__547\n"); );
